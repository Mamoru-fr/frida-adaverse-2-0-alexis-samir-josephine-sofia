    ...
    return (
        <>
            ...
            <form onSubmit={async (e) => {
                ...
                const result = await FormAction(newProjects);
                ...
                <select
                    id="promotion_id"
                    className="border-2 p-2 rounded focus:outline-none focus:border-amber-700"
                    value={newProjects.promotion_id}
                    onChange={(e) =>
                        setNewProjects({
                            ...newProjects,
                ...
                <select
                    id="ada_projects_id"
                    className="border-2 p-2 rounded focus:outline-none focus:border-amber-700"
                    value={newProjects.ada_projects_id}
                    onChange={(e) =>
                        setNewProjects({
                            ...newProjects,
